...
public class Student {
	...
	public Student(final JFrame frame, String username) {
	...
	public void profileEdit(JFrame frame) {		
		...
		final JTextField dobV = new JTextField(""); 
		final JTextField collegeV = new JTextField("");
		final JTextField phoneV = new JTextField("");
		final JTextField gpaV = new JTextField(""); 
