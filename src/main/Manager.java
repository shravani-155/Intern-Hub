...
public class Manager {
	...
	public Manager(final JFrame frame, String username) {
		this.frame = frame;
	...
	public void internshipRequestsApprove(JFrame frame) {
		final JTextField iidT = new JTextField("internship_id");
		iidT.setBounds(80, 150, 150, 40);
		iidT.setFont(new Font("student_id", Font.PLAIN, 16));
		
		final JTextField sidT = new JTextField("student_id");
	...
	public void profileEdit(JFrame frame) {
		...
		final JTextField lnameV = new JTextField("");
		final JTextField companyV = new JTextField(""); 
		final JTextField designationV = new JTextField("");
	...
	public void internshipsPostNew(final JFrame frame) {
		final JTextField iidT = new JTextField();
	...
	public void internshipsPostNewEditPage(JFrame frame, final String iid, final String type ) {
		...
		final JTextField positionV = new JTextField("");
		final JTextField locationV = new JTextField(""); 
	...
	public void internshipsPostedEdit(final JFrame frame) {
		final JTextField iidT = new JTextField();
		iidT.setBounds(150, 150, 150, 40);
		iidT.setFont(new Font("", Font.PLAIN, 16));
		...
		final JButton edit = new JButton("Update");
